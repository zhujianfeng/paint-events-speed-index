...
function row(url, pespeedIndex, speedIndex, perceptualSpeedIndex) {
    ...
    var pespeedIndexStr = pespeedIndex === null || pespeedIndex === void 0 ? void 0 : pespeedIndex.toFixed(0).padEnd(COL_WIDTH);
    var speedIndexStr = speedIndex === null || speedIndex === void 0 ? void 0 : speedIndex.toFixed(0).padEnd(COL_WIDTH);
    var speedIndexDiff = diffTD(pespeedIndex, speedIndex);
    var perceptualSpeedIndexStr = perceptualSpeedIndex === null || perceptualSpeedIndex === void 0 ? void 0 : perceptualSpeedIndex.toFixed(0).padEnd(COL_WIDTH);
