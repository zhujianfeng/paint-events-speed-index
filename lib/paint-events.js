...
var EventFrame = /** @class */ (function () {
    ...
    EventFrame.prototype.calculateGroupPoints = function (x, y, width, height) {
        ...
        var points = inFirstScreenArea;
        if (width > this.viewPortWidth || height > this.viewPortHeight) {
            // 1/(2*e^(2*x))
            points = inFirstScreenArea / (types_1.pointsCalculateParameter1 * Math.pow(Math.E, types_1.pointsCalculateParameter2 * ratio));
        }
        return points;
    };
